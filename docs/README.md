...
- [Proxy Mode](proxy.md) -- enable the MITM proxy, view logs, set up HTTP filtering
...
| [Proxy Mode](proxy.md) | MITM proxy setup, traffic inspection, log viewing and filtering, HTTP request filtering with ask mode, remote logging destinations |
